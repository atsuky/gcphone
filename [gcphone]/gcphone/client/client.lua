...
AddEventHandler("gcPhone:acceptCall", function(infoCall, initiator)
  ...
  if inCall == false and USE_RTC == false then
    ...
    -- exports['epsilon_voip']:SetCallChannel(infoCall.id + 1)

    -- exports.tokovoip_script:addPlayerToRadio(infoCall.id + 1)

    -- TokoVoipID = infoCall.id + 1
...
AddEventHandler("gcPhone:rejectCall", function(infoCall)
  ...
  if inCall == true then
    ...
    -- exports['epsilon_voip']:SetCallChannel(0)
